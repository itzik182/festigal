...
const useStyles = makeStyles((theme) => ({
    ...
    container: {
        background: 'linear-gradient(354deg, rgba(227,223,255,1) 0%, rgba(176,163,255,1) 100%, rgba(255,255,255,1) 100%, rgba(166,151,255,1) 100%);
        filter: 'progid:DXImageTransform.Microsoft.gradient(startColorstr="#e3dfff",endColorstr="#a697ff",GradientType=1)',
